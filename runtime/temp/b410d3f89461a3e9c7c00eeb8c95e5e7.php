<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:36:"./template/index\v1\index\index.html";i:1523179435;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<!-- //for-mobile-apps -->
<link href="/static/v1/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
<link href="/static/v1/css/font-awesome.css" rel="stylesheet"> 
<link href="/static/v1/css/style.css" rel="stylesheet" type="text/css" media="all" />
<!--web-fonts-->
				...
				<ul id="flexiselDemo1">			
					<li>
						<div class="wthree_testimonials_grid_main">
									...
									<img src="/static/v1/images/p1.jpg" alt=" " class="img-responsive" />
						</div>
					</li>
					<li>
						<div class="wthree_testimonials_grid_main">
							
									<img src="/static/v1/images/p2.jpg" alt=" " class="img-responsive" />
						</div>
					</li>
					<li>
						<div class="wthree_testimonials_grid_main">
						
									<img src="/static/v1/images/p3.jpg" alt=" " class="img-responsive" />
						</div>
					</li>
					<li>
						<div class="wthree_testimonials_grid_main">
						
									<img src="/static/v1/images/p6.jpg" alt=" " class="img-responsive" />
						</div>
					</li>
					<li>
						<div class="wthree_testimonials_grid_main">
						
									<img src="/static/v1/images/p4.jpg" alt=" " class="img-responsive" />
						</div>
					</li>
					<li>
						<div class="wthree_testimonials_grid_main">
						
									<img src="/static/v1/images/p5.jpg" alt=" " class="img-responsive" />
						</div>
					</li>
				</ul>
...
<div class="agile-blogs" id="blogs">
	...
	<h3 class="tittle-w3"><span>Popular </span>Recipes</h3>
		<div class="g1 agile-blog1">
			<a href="#"><img src="/static/v1/images/bl1.jpg" alt="blog1"></a>
				<div class="text-w3">
		...
		<div class="g2 agile-blog2">
			<a href="#"><img src="/static/v1/images/bl2.jpg" alt="blog1"></a>
				<div class="text-w3l">
			         ...
			         <ul>
					  <li>
						  <div class="gallery-grid1">
								<a href="single.html"><img src="/static/v1/images/s1.jpg" alt=" " class="img-responsive"></a>
								<div class="p-mask">
					   ...
					   <li>
					     <div class="gallery-grid1">
							<a href="single.html"><img src="/static/v1/images/s2.jpg" alt=" " class="img-responsive"></a>
							<div class="p-mask">
									<h4><span>D</span>elish <span>F</span>ood</h4>
								<p>Neque porro quisquam est, qui dolorem ipsum.</p>
							</div>
						...
						<li>
						   <div class="gallery-grid1">
							<a href="single.html"><img src="/static/v1/images/s3.jpg" alt=" " class="img-responsive"></a>
							<div class="p-mask">
									<h4><span>D</span>elish <span>F</span>ood</h4>
								<p>Neque porro quisquam est, qui dolorem ipsum.</p>
							</div>
					    ...
					    <li>
						  <div class="gallery-grid1">
							<a href="single.html"><img src="/static/v1/images/s4.jpg" alt=" " class="img-responsive"></a>
							<div class="p-mask">
									<h4><span>D</span>elish <span>F</span>ood</h4>
								<p>Neque porro quisquam est, qui dolorem ipsum.</p>
							</div>
...
<!-- //smooth scrolling -->
<script type="text/javascript" src="/static/v1/js/jquery-2.1.4.min.js"></script>
<script type="text/javascript" src="/static/v1/js/numscroller-1.0.js"></script>
<script src="/static/v1/js/particles.js"></script>
<script src="/static/v1/js/app.js"></script>
<!--gallery-->
<script type="text/javascript">
					...
					<script type="text/javascript" src="/static/v1/js/jquery.flexisel.js"></script>
<!--gallery-->
<!-- Dropdown-Menu-JavaScript -->
		...
		<!-- //Dropdown-Menu-JavaScript -->
<!-- Calendar -->
				<link rel="stylesheet" href="/static/v1/css/jquery-ui.css" />
...
<script type="text/javascript" src="/static/v1/js/move-top.js"></script>
<script type="text/javascript" src="/static/v1/js/easing.js"></script>
<script type="text/javascript">
