<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:46:"./template/glt168\admin_v1\system\setting.html";i:1525576234;s:43:"./template/glt168/admin_v1/public/meta.html";i:1525429984;s:45:"./template/glt168/admin_v1/public/footer.html";i:1525418397;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
		...
		<div id="tab-system" class="HuiTab">
			...
			<div class="tabCon">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="5">
					</div>
				</div>
			</div>
			<div class="tabCon">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="25" >
					</div>
				</div>
				<div class="row cl">
