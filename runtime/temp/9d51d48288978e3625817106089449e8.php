<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:42:"./template/glt168\admin_v1\admin\role.html";i:1525596420;s:43:"./template/glt168/admin_v1/public/meta.html";i:1525429984;s:45:"./template/glt168/admin_v1/public/footer.html";i:1525418397;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray"> <span class="l"> <a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" href="javascript:;" onclick="admin_role_add('添加角色','<?php echo url("admin/role_add"); ?>','800')"><i class="Hui-iconfont">&#xe600;</i> 添加角色</a> </span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
	<table class="table table-border table-bordered table-hover table-bg">
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td><?php echo $alist['rolename']; ?></td>
				<td><a href="#"><?php echo $alist['userlist']; ?></a></td>
				<td><?php echo $alist['description']; ?></td>
				<td class="f-14"><a title="编辑" href="javascript:;" onclick="admin_role_edit('角色编辑','<?php echo url("admin/role_edit"); ?>','1')" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> <a title="删除" href="javascript:;" onclick="admin_role_del(this,'1')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
			</tr>
